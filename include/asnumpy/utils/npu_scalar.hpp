 ...
 */
template <typename T> struct TypeToACLDtype;

// Specializations for supported types
template <> struct TypeToACLDtype<float> {
    static constexpr aclDataType value = ACL_FLOAT;
};
template <> struct TypeToACLDtype<double> {
    static constexpr aclDataType value = ACL_DOUBLE;
};
template <> struct TypeToACLDtype<int8_t> {
    static constexpr aclDataType value = ACL_INT8;
};
template <> struct TypeToACLDtype<int16_t> {
    static constexpr aclDataType value = ACL_INT16;
};
template <> struct TypeToACLDtype<int32_t> {
    static constexpr aclDataType value = ACL_INT32;
};
template <> struct TypeToACLDtype<int64_t> {
    static constexpr aclDataType value = ACL_INT64;
};
template <> struct TypeToACLDtype<uint8_t> {
    static constexpr aclDataType value = ACL_UINT8;
};
template <> struct TypeToACLDtype<uint16_t> {
    static constexpr aclDataType value = ACL_UINT16;
};
template <> struct TypeToACLDtype<uint32_t> {
    static constexpr aclDataType value = ACL_UINT32;
};
template <> struct TypeToACLDtype<uint64_t> {
    static constexpr aclDataType value = ACL_UINT64;
};
template <> struct TypeToACLDtype<bool> {
