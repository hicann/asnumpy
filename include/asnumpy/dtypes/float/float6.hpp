...
class float6_e2m3fn {
  ...
  public:
    ...
    static constexpr float6_e2m3fn FromRep(uint8_t rep) { return float6_e2m3fn(rep, ConstructFromRepTag{}); }
...
class float6_e3m2fn {
  ...
  public:
    ...
    static constexpr float6_e3m2fn FromRep(uint8_t rep) { return float6_e3m2fn(rep, ConstructFromRepTag{}); }
