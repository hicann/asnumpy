...
def main():
    np.random.seed(123)
    #测试pareto分布
    ap_pareto_data = ap.pareto(3.0, (10000, ))
    ...
    #测试rayleigh分布
    ap_rayleigh_data = ap.rayleigh(2.0, (10000, ))
    ...
    #测试正态分布
    ap_normal_data = ap.normal(5.0, 2.0, (10000, ))
    ...
    # 测试均匀分布
    ap_uniform_data = ap.uniform(0.0, 1.0, (10000, ))
    ...
    #测试标准正态分布
    ap_standard_normal_data = ap.standard_normal((10000, ))
    ...
    #测试标准柯西分布
    ap_standard_cauchy_data = ap.standard_cauchy((10000, ))
    ...
    # 测试weibull分布
    ap_weibull_data = ap.weibull(1.5, (10000, ))
    ...
    # 测试二项分布
    ap_binomial_data = ap.binomial(10, 0.5, (10000, ))
    ...
    # 测试指数分布
    ap_exp_data = ap.exponential(3.0, (10000, ))
    ...
    # 测试几何分布
    ap_geometric_data = ap.geometric(0.3, (10000, ))
    ...
    # 测试gumbel分布
    ap_gumbel_data = ap.gumbel(0.0, 1.0, (10000, ))
    ...
    # 测试laplace分布
    ap_laplace_data = ap.laplace(0.0, 1.0, (10000, ))
    ...
    # 测试逻辑分布
    ap_logistic_data = ap.logistic(0.0, 1.0, (10000, ))
    ...
    # 测试对数正态分布
    ap_lognormal_data = ap.lognormal(0.0, 1.0, (10000, ))
